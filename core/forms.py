...
class UserRegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Update help texts
        self.fields['username'].help_text = 'Wählen Sie einen eindeutigen Benutzernamen.'
        self.fields['password1'].help_text = 'Ihr Passwort sollte mindestens 8 Zeichen lang sein.'

...
class Schulung(models.Model):
    ...
    art = models.ForeignKey(to=SchulungsArt, on_delete=models.SET_NULL, null=True, blank=True)
...
class SchulungsTermin(models.Model):
    ...
    ort = models.ForeignKey(to=SchulungsOrt, on_delete=models.SET_NULL, null=True, blank=True)
...
class Betrieb(models.Model):
    ...
    telefon = models.CharField(max_length=30, null=True, blank=True)
    email = models.EmailField(null=True, blank=True)
    geschaeftsfuehrer = models.OneToOneField("Person", on_delete=models.SET_NULL, related_name="geschaeftsfuehrer", null=True, blank=True)
...
class Person(models.Model):
    benutzer = models.OneToOneField(User, on_delete=models.SET_NULL, blank=True, null=True)
